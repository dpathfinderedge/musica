...
const TopCharts = () => {
  return (
    ...
    <div className="flex md:flex-col flex-row md:gap-3 gap-4 overflow-x-scroll w-full"> {/**md:mr-6 mr-0 */}
        {chartItems.map((item) => (
          <Link 
            key={item.id}
            to={`/playlist/${item.id}`}
          ...
          >
            <div className="flex md:flex-row flex-col gap-3 bg-dark-alt p-4 rounded-3xl relative w-full"> {/**mb-3 */}
